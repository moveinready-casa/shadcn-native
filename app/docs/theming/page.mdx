...
You can use any of the shadcn/ui themes. See the [shadcn/themes](https://ui.shadcn.com/docs/theming#base-colors) for a full list. You will need to convert them from oklch to a supported color format.
...
> [!NOTE]
>
> At the bottom of the file you will see a global SVGElement class. This is a workaround to fix an issue with [react-aria](https://react-spectrum.adobe.com/react-aria) running on native and it must be kept.
...
- [Themes Stories](/?path=/story/design-system-border-radii)
