...
These are the core dependencies you will need to install to use any of the components. Each component may ship it's own dependencies.
...
- **Web** You made need to manually add the dark class to the body element on web. Add the following to your root layout:
...
> [!IMPORTANT]
>
> Do not use the shadcn init command. It will break your configuration. We are working on our on CLI.
