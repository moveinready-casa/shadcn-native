...
For quick previewing on the web checkout the [storybook](process.env.STORYBOOK_URL).

## Contributing

Contributions are welcome! Please see the [guide](https://github.com/moveinready-casa/shadcn-native/blob/main/CONTRIBUTING.md) before contributing.

## Licensing

Like shadcn/ui this project is licensed under the [MIT license](https://github.com/moveinready-casa/shadcn-native/blob/main/LICENSE).
