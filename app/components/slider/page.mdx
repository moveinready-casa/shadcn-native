...
<div style={{display: "flex", flexDirection: "row", gap: "2rem"}}>
  ...
  <a href="https://github.com/moveinready-casa/shadcn-native/blob/3-create-components/registry/ui/slider.tsx">
...
| `borderRadius`          | `"none" \| "sm" \| "md" \| "lg" \| "full"`                            | `"full"`       | The border radius of the slider thumb.                        |
